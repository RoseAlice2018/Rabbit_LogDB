...
#undef XX
    ...
    void LogEvent::format(const char *fmt, __va_list_tag *al) {
        char* buf = nullptr;
...
public:
    ...
    void format(std::ostream& os,Loggger::ptr logger,
                LogLevel::Level level,LogEvent::ptr event)override{
...
void Logger::setFormatter(const std::string &val) {
    ...
    RabbitLog::LogFormatter::ptr new_val(new RabbitLog::LogFormatter(val));
    if(new_val->isError())
    {
